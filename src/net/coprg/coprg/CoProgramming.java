...
public class CoProgramming {
    ...
    private void initialize() {
        ...
        frmCoprogramming.setTitle(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.frmCoprogramming.title"));
        ...
        JLabel lblCoprogramming = new JLabel(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.lblCoprogramming.text"));
        ...
        authorizePanel.setLayout(new BoxLayout(authorizePanel, BoxLayout.Y_AXIS));
        ...
        JLabel lblStep1 = new JLabel(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.lblStep1.text"));
        ...
        JButton btnLink = new JButton(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.btnLink.text"));
        ...
        JLabel lblStep2 = new JLabel(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.lblStep2.text"));
        lblStep2.setHorizontalAlignment(SwingConstants.LEFT);
        lblStep2.setFont(new Font("Dialog", Font.BOLD, 20));
        panel_3.add(lblStep2);

        JLabel lblEnterCode = new JLabel(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.lblEnterCode.text"));
        ...
        JButton btnAuthorize = new JButton(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.btnAuthorize.text"));
        ...
        JLabel lblConnecting = new JLabel(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.lblConnecting.text"));
        ...
        JButton btnNew = new JButton(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.btnNew.text"));
        btnNew.setFont(new Font("Dialog", Font.PLAIN, 11));
        btnNew.setMargin(new Insets(1,1,1,1));
        toolPanel.add(btnNew);

        JButton btnEdit = new JButton(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.btnEdit.text"));
        btnEdit.setFont(new Font("Dialog", Font.PLAIN, 11));
        btnEdit.setMargin(new Insets(1, 1, 1, 1));
        toolPanel.add(btnEdit);

        JButton btnExecute = new JButton(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.btnExecute.text"));
        btnExecute.setFont(new Font("Dialog", Font.PLAIN, 11));
        btnExecute.setMargin(new Insets(1, 1, 1, 1));
        toolPanel.add(btnExecute);

        JButton btnRefresh = new JButton(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.btnRefresh.text"));
        btnRefresh.setFont(new Font("Dialog", Font.PLAIN, 11));
        btnRefresh.setMargin(new Insets(1, 1, 1, 1));
        toolPanel.add(btnRefresh);

        JButton btnLogout = new JButton(ResourceBundle.getBundle("net.coprg.coprg.messages").getString("CoProgramming.btnLogout.text"));
